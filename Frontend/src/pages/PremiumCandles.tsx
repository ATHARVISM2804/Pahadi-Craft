...
import { ShoppingCart, Star, Heart, Share2, Truck, ShieldCheck } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="text-center mb-20">
        <h1 className="text-4xl md:text-6xl font-serif text-amber-900 mb-6 tracking-tight">Luxury Premium Collection</h1>
        <div className="w-32 h-1 bg-gradient-to-r from-amber-400 via-amber-600 to-amber-300 mx-auto mb-8"></div>
        <p className="max-w-2xl mx-auto text-amber-800 opacity-80 text-lg leading-relaxed">
          Discover our exclusive range of premium candles, meticulously handcrafted using the finest ingredients and unique artisanal techniques. Each piece is a statement of luxury and refinement for your space.
        </p>
      </div>
      ...
      {/* Premium Banner with enhanced design */}
      <div className="relative bg-gradient-to-r from-amber-800 via-amber-900 to-amber-950 p-12 rounded-2xl mb-24 overflow-hidden shadow-2xl">
        <div className="absolute inset-0 opacity-15 mix-blend-overlay">
          <svg className="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="flame" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                <path d="M20 0 C30 10, 10 30, 20 40 C10 30, 30 10, 20 0" fill="currentColor"/>
              </pattern>
            </defs>
        ...
        <div className="relative z-10 text-center">
          <h3 className="text-3xl md:text-4xl font-serif text-amber-200 mb-5">The Art of Luxury</h3>
          <p className="text-white/90 max-w-3xl mx-auto mb-8 text-lg leading-relaxed">
            Our premium candles represent the pinnacle of craftsmanship, featuring exotic fragrances 
            sourced globally and artisanal techniques passed down through generations.
            Each piece is a statement of luxury and refinement.
          </p>
          <div className="inline-flex items-center text-amber-300 font-medium flex-wrap justify-center gap-2">
            <span>Exclusive Collection</span>
            <span className="h-px w-12 bg-amber-300/50 hidden md:block"></span>
